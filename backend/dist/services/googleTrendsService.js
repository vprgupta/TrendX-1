...
exports.scoreTitleAgainstTrends = exports.getGoogleTrends = void 0;
 ...
 */
const getGoogleTrends = async (countryCode = 'US') => {
 ...
 */
const scoreTitleAgainstTrends = (title, trends) => {
    if (!title || trends.length === 0)
        return 0;
...
exports.scoreTitleAgainstTrends = scoreTitleAgainstTrends;
