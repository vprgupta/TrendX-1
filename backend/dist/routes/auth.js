...
router.post('/users', auth_1.authenticate, authController.createUser);
router.put('/users/:id', auth_1.authenticate, authController.updateUser);
router.delete('/users/:id', auth_1.authenticate, authController.deleteUser);
router.patch('/users/:id/status', auth_1.authenticate, authController.updateUserStatus);
